...
const Header = ({ sidebartoggle, setsidebartoggle }) => {
  ...
  return (
    <div
      className={
        !sidebartoggle
          ? "header w-full h-20  bg-themeorange flex justify-between items-center px-5 fixed top-0 left-0"
          : "header headerAdd w-full h-20  bg-themeorange flex justify-between items-center px-5 fixed top-0 left-0"
      }
    >
      ...
      <div className="seachBar flex justify-between items-center">
        <div className="filter flex items-center ml-10  py-3 pr-40 rounded-md bg-themelightorange relative">
          <div className="location-filter px-6 w-56 relative">
            ...
            {locationBox && (
              <ul
                className="w-full absolute py-2 overflow-hidden top-10 bg-white left-0 rounded-md"
                ref={profileRef}
              >
          ...
          {searchBox ? (
            <div
              className="food-options-show absolute top-full left-0 px-7 py-5  bg-white w-full"
              ref={profileRef}
            >
              ...
              <div className="popular-cuisines w-full overflow-x-hidden flex justify-between">
                <AutoPlaySwipeableViews
                  enableMouseEvents
                >
                  <div className="popular-cuisines-slider  min-w-full flex justify-between items-center">
                    {FoodApi.foods.slice(4, 8).map((e) => {
                      return (
                        <>
                          <div
                            className="cuisines border flex justify-center select-none items-center text-center border-themelightgray"
                            key={e.id}
                          >
                  ...
                  <div className="popular-cuisines-slider  min-w-full flex  items-center">
                    {FoodApi.foods.slice(8, 12).map((e) => {
                      return (
                        <>
                          <div
                            className="cuisines border flex justify-center select-none items-center text-center border-themelightgray"
