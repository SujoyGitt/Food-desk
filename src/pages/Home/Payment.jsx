  ...
  return (
    <div className="paymentSection ">
      ...
      <div className="balance mb-5">
        <h3 className="text-lg mb-1 font-semibold opacity-70">Your Balance</h3>
        <img src={Balance} className="w-full " alt="" />
      </div>
      ...
      <div className="cart-container w-full pb-3  ">
        <div className="cart w-full p-2 rounded-md mt-3 flex items-center justify-between">
          <div className="foodimg ">
            <div className="foodimg-inner rounded-md bg-white border border-themeorange"></div>
          </div>
          <div className="price  ">
            <div className="price-header font-semibold   flex items-center justify-between">
              <div className="food-name opacity-70">Panner Pizza</div>
              <div className="food-price text-themeorange">+$5.59</div>
            </div>
            <div className="price-quantity flex items-center my-2 justify-between">
              <span className="text-xs text-themegray">X1</span>
              <div className="quantity rounded-md border border-themeorange bg-white text-sm">
                <span className="text-themeorange  inline-block py-1">-</span>
                <span className="number  inline-block py-1">1</span>
                <span className="text-themeorange  inline-block py-1">+</span>
              </div>
            </div>
          </div>
      ...
      <div className="total flex justify-between items-center">
        ...
        <span className="text-xl text-themeorange font-semibold">+$202.00</span>
      </div>
      <a href="" className="w-full px-3 bg-themeorange rounded-md text-white block text-center mt-3 py-3 hover:bg-themedeeporange"> Checkout</a>
      </div>
