...
const Foodmenu = ({ pagesize }) => {
  ...
  const { filterFoods,sorting,sorting_value } = useFilterContext();
  ...
  return (
    <div className="food-menu ml-auto  mt-28 pb-12">
      <div className="food-menu-container pl-1 sm:pl-14 pr-1 md:pr-8  pt-5 border-b border-themegray pb-5">
        <div className="food-menu-header  flex justify-between items-center flex-wrap">
          <div className="search-bar  flex  cursor-pointer items-center border border-themelightgray py-2.5  rounded-md">
            <svg
              class=" mx-4"
              width="24"
              height="24"
          ...
          <div className="view mt-3 sm:mt-0">
            <ul className="flex items-center sm:justify-end wrap">
              <li
                className={
                  view
                    ? "p-2 rounded-md border mr-3 "
                    : "p-2 rounded-md cursor-pointer border border-themelightorange border-opacity-25 bg-themeloworange mr-3"
                }
              ...
              <li
                className={
                  !view
                    ...
                    : "p-1 rounded-md cursor-pointer border border-themelightorange border-opacity-25 bg-themeloworange"
                }
        ...
        <div className="food-menu-filter my-7">
          <ul className="flex items-center flex-wrap" id="filter">
            <li className="mt-3 sm:mb-0">
              <NavLink onClick={sorting} className="text-sm active:bg-themeorange active:border-0 active:text-white border rounded-md px-3 py-2.5 font-light text-themegray">
                All
              </NavLink>
            </li>
            <li className="mt-3 sm:mb-0">
              <NavLink onClick={sorting} className="text-sm active:bg-themeorange active:border-0 active:text-white border rounded-md px-3 py-2.5 font-light text-themegray mx-4">
                Exclusive
              </NavLink>
            </li>
            <li className="mt-3 sm:mb-0">
              <NavLink onClick={sorting} className="flex active:bg-themeorange active:border-0 active:text-white items-center text-sm border rounded-md px-3 py-2.5 font-light text-themegray mr-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#9C9C9C"
                  width="18"
            ...
            <li>
              <NavLink onClick={sorting} className="flex active:bg-themeorange active:border-0 active:text-white items-center text-sm border rounded-md p-3 font-light text-themegray mr-4 mt-3 sm:mb-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#9C9C9C"
                  width="18"
            ...
            <li>
              <NavLink onClick={sorting} className="active:bg-themeorange active:border-0 active:text-white flex items-center text-sm border rounded-md p-3 font-light text-themegray mr-4 mt-3 sm:mb-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#9C9C9C"
                  width="18"
        ...
        <div className="food-menu-card-container w-full flex justify-between items-center flex-wrap">
          {filterFoods?.slice(pagesize[0], pagesize[1]).map((e, key) => {
            return (
              <Tilt options={defaultOptions}>
                <div
                  className="food-menu-card relative p-4 border rounded-md hover:border-themeorange"
                  key={key}
                  onClick={() => navigate(`/food-details/${e.name}`)}
                >
                  ...
                  <div className="addtocart absolute bottom-4 right-5 bg-themeorange p-2.5 rounded-md cursor-pointer">
                    <img
        ...
        <div className="navigator w-full flex items-center justify-between">
          <h4 className="text-sm text-themegray">
            Showing {pagesize[0]}-{pagesize[1]} from {filterFoods.length} data
          </h4>
      ...
      <p className="text-sm text-themegray m-auto text-center pt-4">
